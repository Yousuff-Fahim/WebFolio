        ...
        ?>
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="<?php echo ($row['profilepic']); ?>" onerror="this.style.display='assets/img/profile-img.jpg'" alt="Profile" class="rounded-circle">
              ...
              <div class="social-links mt-2">
                ...
                <a href="<?php echo ($row['linkedin']); ?>" class="linkedin"><i class="bi bi-linkedin"></i></a>
                <a href="<?php echo ($row['youtube']); ?>" class="youtube"><i class="bi bi-youtube"></i></a>
              </div>
            </div>
          </div>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo ($row['title']); ?></div>
                  </div>
                  ...
                  <form>
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="<?php echo ($row['profilepic']); ?>" onerror="this.style.display='assets/img/profile-img.jpg'" alt="Profile">
                        <div class="pt-2">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="job" type="text" class="form-control" id="Job" value="<?php echo ($row['username']); ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="job" type="text" class="form-control" id="Job" value="<?php echo ($row['title']); ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      <label for="Linkedin" class="col-md-4 col-lg-3 col-form-label">YouTube Profile</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="linkedin" type="text" class="form-control" id="Linkedin" value="<?php echo ($row['youtube']); ?>">
                      </div>
                    </div>
